source $HOME/.config/nvim/plugins/itchyny/lightline.vim
source $HOME/.config/nvim/plugins/scrooloose/nerdtree.vim
source $HOME/.config/nvim/plugins/Yggdroot/indentLine.vim
source $HOME/.config/nvim/plugins/airblade/vim-gitgutter.vim
